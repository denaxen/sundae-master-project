...
SSH to the machine and clone your repository in your PVC / shared storage.
   ...
   mkdir diffusion-llms-project
   git clone <git SSH URL> diffusion-llms-project/dev
   git clone <git SSH URL> diffusion-llms-project/run
   ```
   ...
   ```bash
   cd diffusion-llms-project/dev && git config core.filemode false
...
...
[TEMPLATE INFO] PROJECT_ROOT_AT is set to /claire-rcp-scratch/home/moalla/diffusion-llms-project/dev.
[TEMPLATE INFO] Expecting workdir to be /claire-rcp-scratch/home/moalla/diffusion-llms-project/dev.
[TEMPLATE INFO] Installing the project with pip.
[TEMPLATE INFO] Expecting /claire-rcp-scratch/home/moalla/diffusion-llms-project/dev to be a Python project.
[TEMPLATE INFO] To skip this installation use the env variable SKIP_INSTALL_PROJECT=1.
Obtaining file:///claire-rcp-scratch/home/moalla/diffusion-llms-project/dev
  Installing build dependencies: started
  ...
  Building editable for diffusion-llms-project (pyproject.toml): started
  ...
Successfully built diffusion-llms-project
Installing collected packages: diffusion-llms-project
Successfully installed diffusion-llms-project-0.0.1
...
3. Then follow the instructions [here](https://www.jetbrains.com/help/pycharm/remote-development-a.html#gateway) and
   ...
   something like `/claire-rcp-scratch/home/moalla/diffusion-llms-project/dev`).
...
4. Otherwise, your container prints a link to the IDE that you can find it its logs.
   ...
   ```bash
    Gateway link: jetbrains-gateway://connect#idePath=%2Fclaire-rcp-scratch%2Fhome%2Fmoalla%2Fremote-development%2Fpycharm&projectPath=%2Fclaire-rcp-scratch%2Fhome%2Fmoalla%2Fdiffusion-llms-project%2Fdev&host=127.0.0.1&port=2223&user=moalla&type=ssh&deploy=false&newUi=true
    ```
