...
PROJECT_NAME=diffusion-llms-project
PACKAGE_NAME=diffusion_llms_project
...
push_usr_or_root() {
  ...
  if [ "${PUSH_IMAGE_NAME}" == "" ]; then
    ...
    echo "For example: ./template.sh push docker.io/docker-username/diffusion-llms-project"
